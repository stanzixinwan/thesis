...
\begin{figure}[htbp]
  ...
  \textit{Left}: Schematic of the two-photon imaging preparation, 
  ...
  \textit{Center}: Example drifting grating stimulus used to 
  characterize neuronal tuning. 
  \textit{Right}: The stimulus set consisted of a factorial 
...
\begin{figure}[htbp]
  ...
  visual cortex. \textit{Left}: Field of view showing fluorescently 
  labeled neurons imaged with a two-photon microscope. 
  \textit{Right}: Fluorescence response traces ($\delta$F/F) for a sample of 16 
  individual cells (ref t00007) in response to visual stimulation. 
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\linewidth]{figures/DSI_OSI_Heatmap.png}
